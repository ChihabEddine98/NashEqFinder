...
class WelcomePage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.btnDicho.configure(text='''Pure NE''')
        self.btnDicho.configure(command=lambda: controller.show_frame("PureNEPage"))
        ...
        self.btnNewton.configure(text='''Mixed NE''')
        self.btnNewton.configure(command= lambda : controller.show_frame("MixedNEPage"))
        ...
        self.btnCordes.configure(text='''AiO''')
        self.btnCordes.configure(command= lambda : controller.show_frame("AiOPage"))
