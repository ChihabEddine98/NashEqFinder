...
class MixedNEPage(tk.Frame):
    ...
    def __init__(self, parent,controller):
        ...
        self.titleLabel = tk.Label(self.titleFrame,justify="center")
        self.titleLabel.place(relx=0.172, rely=0.241, height=34, width=600)
        ...
        self.titleLabel.configure(text='''Mixed Strategies Nash Equilibria''')
