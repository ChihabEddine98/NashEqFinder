...
#    Oct 27, 2020 12:53:36 PM CET  platform: Windows NT
...
def vp_start_gui():
    ...
    root = tk.Tk()
    top = PureNEPage (root)
    PureNEPage_support.init(root, top)
    root.mainloop()

w = None
def create_PureNEPage(rt, *args, **kwargs):
    '''Starting point when module is imported by another module.
       Correct form of call: 'create_PureNEPage(root, *args, **kwargs)' .'''
    global w, w_win, root
    #rt = root
    root = rt
    w = tk.Toplevel (root)
    top = PureNEPage (w)
    PureNEPage_support.init(w, top, *args, **kwargs)
    return (w, top)

def destroy_PureNEPage():
    global w
    w.destroy()
    w = None
...
class PureNEPage:
    def __init__(self, top=None):
        ...
        self.payoffEntryL00.place(relx=0.161, rely=0.318, height=24
                , relwidth=0.203)
        self.payoffEntryL00.configure(background="white")
        self.payoffEntryL00.configure(disabledforeground="#a3a3a3")
        self.payoffEntryL00.configure(font="TkFixedFont")
        ...
        self.payoffEntryR00.place(relx=0.594, rely=0.318, height=24
                , relwidth=0.203)
        self.payoffEntryR00.configure(background="white")
        self.payoffEntryR00.configure(disabledforeground="#a3a3a3")
        self.payoffEntryR00.configure(font="TkFixedFont")
        ...
        self.payoffEntryL01.place(relx=0.161, rely=0.318, height=24
                , relwidth=0.203)
        self.payoffEntryL01.configure(background="white")
        self.payoffEntryL01.configure(disabledforeground="#a3a3a3")
        self.payoffEntryL01.configure(font="TkFixedFont")
        ...
        self.payoffEntryR01.place(relx=0.594, rely=0.318, height=24
                , relwidth=0.203)
        self.payoffEntryR01.configure(background="white")
        self.payoffEntryR01.configure(disabledforeground="#a3a3a3")
        self.payoffEntryR01.configure(font="TkFixedFont")
